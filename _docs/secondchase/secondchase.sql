...
show create table `mz_prize`;


ALTER TABLE `mz_prize` ADD `image_url2` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片2' AFTER `image_url`;
ALTER TABLE `mz_prize` ADD `image_prize_url` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '奖品图片' AFTER `image_url2`;


CREATE TABLE `mz_prize` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '奖品ID',
  `name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '名称',
  `image_url` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片',
  `image_url2` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片2',
  `image_prize_url` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '奖品图片',
  `prize_status` int(11) NOT NULL COMMENT '奖品状态',
  `level` int(11) NOT NULL COMMENT '奖品级别',
  `sort` int(11) NOT NULL COMMENT '排序',
  `quantity` int(11) NOT NULL COMMENT '初始数量',
  PRIMARY KEY (`id`)
